...
make simulate     # Play N headless battles and log balance/outcome data
```

`make play` runs a debug build. Press `F9` from a campaign screen to open the
development-only scenario menu; see
[docs/dev/running-the-game.md](docs/dev/running-the-game.md) for the full
scenario list. The menu is not created in non-debug exports.
...
See [docs/dev/testing.md](docs/dev/testing.md) for the full test-writing
